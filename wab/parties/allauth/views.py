...
from wab.parties.allauth.forms import ConfirmEmailForm, RequestConfirmEmailForm
from wab.parties.allauth.serializers import RegisterUserSerializer, LoginUserSerializer
...
class RequestConfirmEmailView(FormView):
    ...
    def get_form_kwargs(self):
        ...
        # user = self.check(self.request, email)
        # self.request.user = user
