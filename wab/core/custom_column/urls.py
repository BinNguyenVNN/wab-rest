...
from wab.core.custom_column.api.views import CustomColumnTypeViewSet, \
    ...
    CustomColumnValidatorListByCustomColumnIdView, CreateCustomColumnTypeView, CreateTableWithColumn
...
urlpatterns = [
                  ...
                  path("create-table-with-column/<int:connection_id>/", CreateTableWithColumn.as_view(),
                       name='CreateTableWithColumn'),
              ] + router.urls
