    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', models.CharField(blank=True, choices=[('in', 'in'), ('contain', 'contain')], default='contain', max_length=32, null=True)),
                ...
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='custom_column_fk_customcolumnfk_creator', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('last_modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='custom_column_fk_customcolumnfk_last_modified', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
            ],
            options={
